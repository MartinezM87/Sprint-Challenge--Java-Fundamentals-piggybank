...
- We created seed data and allowed the application to use that set of objects to return data in the endpoint.
...
-Java requires certain things to be there before anything can happen. One mistake or one feature left out can cause the whole application to crash.
